...
void app_main(void)
{
    ...
    if (err == ESP_OK)
    {
        ...
        pca9685_i2c_led_count(pca9685_1, SERVO_OUTPUT_PIN_1, 307);
        pca9685_i2c_hal_ms_delay(1000 * 10);

        while(1)
        {
            pca9685_i2c_led_count(pca9685_1, SERVO_OUTPUT_PIN_1, 100);
            pca9685_i2c_hal_ms_delay(1000 * 3);
            pca9685_i2c_led_count(pca9685_1, SERVO_OUTPUT_PIN_1, 300);
            pca9685_i2c_hal_ms_delay(1000 * 3);
            pca9685_i2c_led_count(pca9685_1, SERVO_OUTPUT_PIN_1, 500);
            pca9685_i2c_hal_ms_delay(1000 * 10);
        }
    }
    else{
